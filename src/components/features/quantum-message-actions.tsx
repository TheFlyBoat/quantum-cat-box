      ...
      >
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              aria-label={
                isDiarySaved ? 'Remove from Cat Diary' : 'Save to Cat Diary'
              }
              className={cn(
                interactiveMotion,
        ...
        <Button
          ...
          className={cn(
            ...
            interactiveMotion,
            hasSharedQuantumMessage &&
              'from-[#A9DB4A] via-[#A9DB4A] to-[#A9DB4A] text-[#002D41] hover:brightness-110'
          )}
          aria-pressed={hasSharedQuantumMessage}
          aria-label={
            hasSharedQuantumMessage ? 'Quantum Message shared' : 'Share'
          }
